                ...
                <div class="card">
                    <div class="body">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <asp:Literal ID="ltRole" runat="server" Visible="false" />
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <asp:TextBox ID="txtDesc" runat="server" CssClass="form-control" MaxLength="50" autofocus autocomplete="off" />
                                <label class="form-label">Description</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="checkbox">
                                <asp:CheckBoxList ID="cbModules" runat="server" RepeatLayout="Table" />
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="card">
                    <div class="body">
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                <asp:ListView ID="lvRoles" runat="server" OnItemCommand="lvRoles_ItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <asp:Literal ID="ltRoleID" runat="server" Text='<%# Eval("RoleID") %>' /></td>
                                            <td><%# Eval("Name") %></td>
